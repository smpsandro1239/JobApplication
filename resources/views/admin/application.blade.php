                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            @if($application->user->cv) <!-- Check if CV exists for the user -->
                            <a href="{{ asset('storage/' . $application->user->cv) }}" class="btn btn-link" download>
                              Download CV
                            </a>
                            @else
                          ...
                          <td>
                            <form
                              action="{{ route('admin.updateApplicationStatus', $application->id) }}"
